# 1. 解释型语言需要解释器才能运行，编译型语言可以直接生成exe运行
# 3.一个字节等于8位
# 4.ascii最早期的编码，unicode是通用型编码，比较占位置。utf-8相对于unicode精简，gbk是正对中文的编码
# 5.在第一行加上   -*-unicode-*-    默认都是utf-8
# 6.占位，完整语句，无特殊作用，作用就是啥作用也没有
# 7.==是值比较，is是内存位置比较
# 8.？
# 9.数字字母和下划线，第一个不能是数字，意思尽量一目了然
# 10.0，[],{},(),
# 11.字符串1，元组1，数字1
# 12.列表，集合，字典
# 13.字符串，整型，布尔，浮点，元组
